...
def home_page():
    ...
    # st.caption("Sample data displayed below:")
...
# def home_page():
#     # Display text
#     st.title("Epsilon Real Estate Predictor")
#     st.header("Welcome to the Property Price Prediction Tool")
#     st.subheader("This tool helps you estimate property prices.")
...
#     property_type = st.selectbox("Property Type", [1, 0, 3, 2])
#     city = st.selectbox("City", [4, 3, 0, 1, 2])
    
#     if st.button("Predict"):
#         predict(area, rooms, property_type, city)

# def plots(result=0):
#     # Plotting the result and some visualizations
#     st.title("Result")
    
#     st.markdown(f"**Estimated Property Price: {result:,} AED**")
